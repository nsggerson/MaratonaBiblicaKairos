...
abstract class BaseController
{
    ...
    protected function setTransportScreen(array $param)
    {
        if($_SESSION['transport']){
            unset($_SESSION['transport']); 
        }
        session_start();
        return $_SESSION['transport']= $param;        
    }

    protected function getAndTransportScreen($param = null)
    {        
        if($param == null){            
